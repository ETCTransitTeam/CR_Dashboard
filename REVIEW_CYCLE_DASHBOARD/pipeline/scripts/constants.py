...
final_results_columns_ls6=['id', 'datesubmitted', 'intervinit', 'routesurveyedcode', 'routesurveyed', 'have5minforsurvecode', 'have5minforsurve', 'origintransportcode', 'origintransport', 'originplacetype', 'destintransportcode', 'destintransport', 'destinplacetype', 'elviscomment', 'elvisstatus', 'intrvnote', 'routestatus', 'stopsstatus', 'teststatus']
