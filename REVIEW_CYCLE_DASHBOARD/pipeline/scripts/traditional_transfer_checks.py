...
# old_df = pd.read_csv('elvistucson2025obweekday_export_odbc.csv')

# # List of columns to modify
# columns_to_check = [
#     'TRIP_FIRST_ROUTECode','TRIP_SECOND_ROUTECode','TRIP_THIRD_ROUTECode','TRIP_FOURTH_ROUTECode','TRIP_NEXT_ROUTECode','TRIP_AFTER_ROUTECode','TRIP_3RD_ROUTECode','TRIP_LAST4TH_RTECode','ROUTE_SURVEYEDCode'
# ]

# # Replace "SUN_2" with "SUN_1" only for non-empty values
# for col in columns_to_check:
#     if col in old_df.columns:  # Check if the column exists in the DataFrame
#         old_df[col] = old_df[col].apply(lambda x: x.replace('SUN_2', 'SUN_1') if isinstance(x, str) and x.startswith('SUN_2') else x)

# # Save the modified DataFrame
# old_df.to_csv('modified_triproutes_elvistucson2025obweekday_export_odbc.csv', index=False, na_rep='')
# print("Route_Trips converted...")
...
# # df=pd.read_csv('modified_triproutes_elvistucson2025obweekday_export_odbc.csv')
# elvis_df=pd.read_excel(file_name,sheet_name='Elvis_Review')
...
# file_name = 'HRT_KINGElvis.xlsx'
# detail_df=pd.read_excel("details_hrta_va_od_excel (1).xlsx",sheet_name='STOPS')
# df=pd.read_csv('elvishrtva2023obweekday_export_odbc(db02).csv')

# file_name = '2023_GCRTA_KINGElvis.xlsx'
# detail_df=pd.read_excel("details_2023_GCRTA_od_excel.xlsx",sheet_name='STOPS')
# df=pd.read_csv('elvisawsclevelandrta2023obweekday_export_odbc(db02).csv')

# file_name = 'COTA_KINGElvis (4).xlsx'
# detail_df=pd.read_excel("details_project_od_excel_COTA (1).xlsx",sheet_name='STOPS')
...
# detail_df=pd.read_excel("details_project_VICTOR_CA_excel.xlsx",sheet_name='STOPS')
# df=pd.read_csv('elvisvictorvalley2023obweekday_export_odbc(db05).csv')
