...
from views.ui import action_row, filter_panel, info_strip, page_header, section_title
...
def render_history_page(user: dict) -> None:
    ...
    if is_cleaning:
        subtitle = (
            "Cleaning-team audit trail: who changed what, when, and why. "
            "Showing **cleaning team changes only**."
        )
    elif is_review:
        subtitle = (
