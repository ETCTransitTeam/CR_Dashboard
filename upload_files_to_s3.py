...
if __name__ == "__main__":
    file_name = 'details_KCATA_od_excel.xlsx'  # Replace with your Excel file path
    bucket_name = 'etc-streamlit'  # Replace with your S3 bucket name
    object_name = 'details_KCATA_od_excel.xlsx'  # Replace with the desired S3 object name
